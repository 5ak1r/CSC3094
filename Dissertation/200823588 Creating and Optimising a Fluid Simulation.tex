...
\begin{document}
    ...
    Once the spatial hash has been implemented, it needs to be integrated into the simulation loop.
    ...
    \begin{algorithm}[H]
        ...
        \begin{algorithmic}[1]
            ...
            \ForAll{particles $i$}
                \State calculate the cell its hash key
            \EndFor
